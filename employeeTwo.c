...
{ 
    return * (long *) targetPtr != tableValuePtr->number; //const void *targetPtr ==> 
                                                          //typecast as int pointer then dereference 
} 

static int compareEmployeeName(const void *targetPtr, PtrToConstEmployee tableValuePtr) 
{ 
    return strcmp((char *) targetPtr, tableValuePtr->name);//const void *targetPtr ==> 
                                                           //typecast as char pointer then pass into strcmp() 
}
...
//no other files can access static funcitons!!!!!!!!!!!!!!!